    ...
    columns: [
      ...
      },
      {
        fields: [
          ...
          {
            label: 'Total Number JV Partners',
            value: formatAssetDisplayCount(
              readPropertyDetailNumber(detail, 'total_jv_partners', 'totalJvPartners'),
            ),
          },
        ],
      },
...
function buildFinancialMetricsBlock(
  ...
  return {
    ...
    rightItems: [
      ...
      scalableCurrency('AFFO', metrics?.assetAffo),
      scalableCurrency('NCF', metrics?.assetNcf),
      scalableCurrency('EBITDA', metrics?.assetEbitda),
      scalableCurrency('Revenue', metrics?.assetRevenue),
      scalableCurrency('Expense', metrics?.assetExpense),
      ...
      scalableCurrency('Same Store NOI Growth', metrics?.sameStoreNoiGrowthAmount),
